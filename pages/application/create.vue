...
const formSchema = toTypedSchema(
  zod.object({
    ...
    restricted_role_ids: zod.string().array(),
    accepted_role_ids: zod.string().array(),
    denied_role_ids: zod.string().array(),
    ping_role_ids: zod.string().array(),
    accept_removal_role_ids: zod.string().array(),
    deny_removal_role_ids: zod.string().array(),
    pending_role_ids: zod.string().array(),
  }),
);
